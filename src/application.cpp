...
namespace Renderer {
    Application::Application(int screenWidth, int screenHeight)
            : Screen_(screenWidth, screenHeight), Window_(sf::VideoMode(screenWidth, screenHeight), "Test" /* TODO */) {
    ...
    void Application::ProcessKeyPressedEvent(const sf::Event::KeyEvent &keyEvent) {
        ...
        static const Eigen::Vector3d left = Eigen::Vector3d(-default_speed, 0, 0);
        static const Eigen::Vector3d right = Eigen::Vector3d(default_speed, 0, 0);
        static const Eigen::Vector3d forward = Eigen::Vector3d(0, 0, -default_speed);
        static const Eigen::Vector3d back = Eigen::Vector3d(0, 0, default_speed);
